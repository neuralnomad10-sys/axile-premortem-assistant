...
with st.expander("📊 Government Data Sources & Evidence"):
    ...
    **Australian Innovation Statistics**
    ...
    - Years: 2025 
    - URL: [Australian Innovation Statistics](https://www.industry.gov.au/publications/australian-innovation-statistics#container-20997)
    - Key Metrics: Innovation outcomes by skills, sector, collaboration patterns, productivity impacts
