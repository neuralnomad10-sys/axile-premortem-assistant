...
with st.expander("📊 Government Data Sources & Evidence"):
    ...
    **Australian Innovation Statistics**
    ...
    - Years: 2025
    - URL: [Australian Innovation System Monitor](https://www.industry.gov.au/publications/australian-innovation-statistics#container-20997)
    - Key Metrics: Innovation rates by skills, sector, collaboration patterns, innovation outcomes
